...
![alt text](<screenshots/verify ubuntu VM.png>)
...
![alt text](<screenshots/pravinmishra portfolio.png>)
...
![alt text](<screenshots/footer updated.png>)


![alt text](screenshots/nano-updated2.png)
...
![alt text](<screenshots/test-nginx config.png>)

---

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![alt text](<screenshots/website verified.png>)
...
![alt text](<screenshots/broswer live footer.png>)
...
![alt text](<screenshots/http response ok.png>)
...
![alt text](<screenshots/mini real linkedln.png>)
